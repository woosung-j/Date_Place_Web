...
<body>
    <div class='container'>
        <header class=''>
            <nav
                class='row navbar bg-light text-center align-middle fixed-top'
            >
        ...
        <div class='row pt-62'>
            ...
            <form action='outusercheck' class='d-grid col-11 mx-auto mt-0'>
                <a	href='userout'
                    type='button'
                    class='btn btn-danger btn-lg col-12 mt-3 mx-auto'
                >
                   탈퇴하기
                </a>
   			</form> 
    ...
    <div class='modal' id='fixModal' tabindex='-1'>
        <div class='modal-dialog modal-dialog-centered'>
            <div class='modal-content mx-5'>
                ...
                <div id='modalBtn'>
                    <a href='mypage' class='btn btn-primary btn-lg col-12'>
                        확인
                    </a>
                </div>
            </div>
