                ...
                $.ajax({
                    ...
                    success: (data) => {
                        ...
                        if (input != data.userName) {
                            ...
                            $('#fixUserBtn').click(() => {
                                if (isVal($('#userId:checked')) && isVal($('#userName')) && isVal($('#nickname')) && isVal($('#userTel')) && isVal($('#email')) && isVal($('#birthday'))) {
                                    $.ajax({
            ...
            <div class="col mt-4">
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col mb-2">
                            <div class="button">
                                <button id="getUserBtn" type="button" class="btn btn-info col-3 mr-4">조회</button>
                                <button id="fixUserBtn" type="button" class="btn btn-warning col-3 mr-4">선택 수정</button>
                                <button id="delUserBtn" type="button" class="btn btn-danger col-3">선택 탈퇴</button>
                            </div>
                        </div>
                    </div>
