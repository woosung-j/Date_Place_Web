            ...
            <div class="col mt-4">
                <form>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-6">
                            <input type="tel" class="form-control" id="tel" value="01027970703" />
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="openingHours" class="col-sm-2 col-form-label">오픈 시간:</label>
                        <div class="col-sm-6">
                            <input type="openingHours" class="form-control" id="openingHours" value="11:00" />
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="closingHours" class="col-sm-2 col-form-label">마감 시간:</label>
                        <div class="col-sm-6">
                            <input type="closingHours" class="form-control" id="closingHours" value="18:00" />
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="contact" value="http://blog.nver.com.veo_wj" />
                        </div>
                    </div>
                </form>
            </div>
