			...
			<div class="col mt-4">
				<form>
						...
						<div class="col mt-4">
							<div class="button">
								<button type="button" class="btn btn-primary col-3"
									data-toggle="modal" data-target="#submitModal">완료</button>
							</div>
						</div>
					</div>
					<hr/>
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-6">
						<input type="text" class="form-control" id="address" value="서울 관악구 남부순환로 1594-4 5층"/>
							<script
								src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
							<script>
					...
					<div class="mb-3 row">
						<label for="openingHours" class="col-sm-2 col-form-label">오픈
							시간:</label>
						<div class="col-sm-6">
							<input type="openingHours" class="form-control" id="openingHours"
								value="11:00" />
						</div>
					</div>
					<div class="mb-3 row">
						<label for="closingHours" class="col-sm-2 col-form-label">마감
							시간:</label>
						<div class="col-sm-6">
							<input type="closingHours" class="form-control" id="closingHours"
								value="18:00" />
						</div>
					</div>
					<div class="mb-3 row">
						...
						<div class="col-sm-6">
							...
							<label><input type="checkbox" name="dayoff" checked value="화요일"> 화요일</label> 
							...
							<label><input type="checkbox" name="dayoff" checked value="일요일"> 일요일</label>
						</div>
					</div>
					<div class="mb-3 row">
						<label for="parkingLot" class="col-sm-2 col-form-label">주차:</label>
						<div class="dropdown col d-inline-block">
							<select id="parkingLot" class="dropdown-toggle text-dark"
								style="width: 15rem">
								<option>불가능</option>
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="contact"
								value="http://blog.nver.com.veo_wj" />
						</div>
					</div>
				</form>
			</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<a href="../place/02.html" class="close text-black"> <span>&times;</span>
					</a>
				</div>
