	...
	$.ajax({
		...
		success: placeList => {   
			...
			if(placeList.length) {
				...
				'<tr><td colspan=4 class=text-center>등록된 장소가 없습니다.</td></tr>')
		}
	})
}
$(() => {
			...
			<div class="col mt-4">
				<div class="row-1">
					<nav class="d-flex mb-4" style="float: right">
						<a href="./03.html" class="btn btn-primary mr-1"> <span
							class="label d-none d-sm-inline">장소추가</span>
						</a>
						<button type="button" class="btn btn-danger" data-toggle="modal"
							data-target="#delPlaceModal">
					...
					<div class="row-1">
						<table table class="table text-center border-bottom">
							<thead class=""
								style="background-color: #7882A4; color: #D6E5FA;">
								<tr>
								<th>선택</th>
								<th>장소명</th>
								</tr>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a href="#infoModal" class="btn btn-primary" data-toggle="modal"
						data-target="#infoModal" data-dismiss="modal">확인</a>
				</div>
			</div>
		</div>
	</div>
	<div class="modal" tabindex="-1" id="infoModal">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="#" class="btn btn-primary btn-lg col-12"
