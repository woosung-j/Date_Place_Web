...
-- insert --
-- users
insert into date2.users values(date2.users_id_seq.nextval, 'user', 'a@b.com', 'user', '최한석', '01075463543', '한석', 'img1.jpg', '1998-01-02', sysdate, sysdate);
insert into date2.users values(date2.users_id_seq.nextval, 'user2', 'a@c.com', 'user2', '한아름', '01042345342', '아름', 'img2.jpg', '1999-04-03', sysdate, sysdate);
insert into date2.users values(date2.users_id_seq.nextval, 'user3', 'a@d.com', 'user3', '김선우', '01025545242', '선우', 'img3.jpg', '1989-03-04', sysdate, sysdate);
insert into date2.users values(date2.users_id_seq.nextval, 'user4', 'a@e.com', 'user4', '김승일', '01025545242', '승일', 'img4.jpg', '1989-03-04', sysdate, sysdate);
insert into date2.users values(date2.users_id_seq.nextval, 'user5', 'a@f.com', 'user5', '이승원', '01025545242', '승원', 'img5.jpg', '1989-03-04', sysdate, sysdate);

-- admins
insert all
    into date2.users values(date2.users_id_seq.nextval, 'admin', 'a@g.com', 'admin', '경서', '01036457459', 'adm1', 'img5.jpg', '1997-08-05', sysdate, sysdate)
    into date2.admins values(date2.users_id_seq.currval)
    select * from dual;
insert all
    into date2.users values(date2.users_id_seq.nextval, 'admin2', 'a@h.com', 'admin2', '김현성', '01047543534', 'adm2', 'img7.jpg', '1996-02-04', sysdate, sysdate)
    into date2.admins values(date2.users_id_seq.currval)
    select * from dual;
